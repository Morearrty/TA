...
<head>
    ...
    <title>Ajukan Kegiatan Baru - TA-AMS</title>
        ...
        <div class="content-wrapper" id="content">
            ...
            <div class="top-bar">
                <div class="d-flex align-items-center">
                    ...
                    <h4 class="page-title mb-0 ms-md-2">Ajukan Kegiatan Baru</h4>
                </div>
            </div>
            
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="header-purple mb-0">Formulir Pengajuan Kegiatan - {{ $district->name }}</h5>
                    <a href="{{ route('district.proposals.index') }}" class="btn btn-secondary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('district.proposals.store') }}" method="POST">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-md-6">
